...
**shiro-pac4j-spring-boot-starter** is a Spring Boot starter that integrates **pac4j-biz** for applications using pac4j-biz. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume pac4j-biz capabilities with minimal setup.
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:shiro-pac4j-spring-boot-starter:2.7.x.20260527-SNAPSHOT` |
