...
**Spring Boot Starter，集成 pac4j-biz**
...
**shiro-pac4j-spring-boot-starter** 是一个面向 使用 pac4j-biz 的应用 的 Spring Boot Starter，用于将 **pac4j-biz** 集成到 Spring Boot 应用中。它提供自动装配、属性绑定与开箱即用的 Bean，使应用以最小配置即可使用 pac4j-biz 的全部能力。

| 维度 | 说明 |
|---|---|
| 类型 | Spring Boot Starter |
| 消费方 | 使用 pac4j-biz 的 Spring Boot 应用 |
| 核心能力 | 自动装配、属性绑定、开箱即用的 pac4j-biz Bean |
| JDK | `17` |
| 坐标 | `io.github.easy4j:shiro-pac4j-spring-boot-starter:3.2.x.20260527-SNAPSHOT` |
| 配置前缀 | `shiro.pac4j` |
...
| 能力 | 状态 | 说明 |
|---|:---:|---|
| 自动装配 | ✅ 稳定 | 自动注册 pac4j-biz 相关 Bean |
