...
public class ShiroPac4jCasAutoConfiguration {
    ...
    */
    ...
    public ServletListenerRegistrationBean<SingleSignOutHttpSessionListener> singleSignOutHttpSessionListener(ShiroPac4jProperties properties) {  
	 ...
	 */
	@Bean
	public FilterRegistrationBean singleSignOutFilter(ShiroPac4jProperties properties) {
	 ...
	 */
	@Bean
	public FilterRegistrationBean authenticationFilter(ShiroPac4jProperties properties){
		FilterRegistrationBean filterRegistration = new FilterRegistrationBean();
		filterRegistration.setEnabled(properties.isEnabled());  
	 ...
	 */
	@Bean
	public FilterRegistrationBean ticketValidationFilter(ShiroPac4jProperties properties ){
		FilterRegistrationBean filterRegistration = new FilterRegistrationBean();
		filterRegistration.setEnabled(properties.isEnabled()); 
	 ...
	 */
	@Bean
	public FilterRegistrationBean httpServletRequestWrapperFilter(ShiroPac4jProperties properties ){
		FilterRegistrationBean filterRegistration = new FilterRegistrationBean();
	 ...
	 */
	@Bean
	public FilterRegistrationBean assertionThreadLocalFilter(ShiroPac4jProperties properties) {
		FilterRegistrationBean filterRegistration = new FilterRegistrationBean();
